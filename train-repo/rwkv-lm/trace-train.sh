...
TORCH_EXTENSIONS_DIR="${TORCH_EXTENSIONS_DIR:-/tmp/torch_extensions/rwkv-lm}" \
MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/matplotlib-rwkv-lm}" \
uv run python train.py \
  --load_model "" --wandb "" --proj_dir out_trace/L12-D768-x070 \
