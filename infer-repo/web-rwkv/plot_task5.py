...
def main() -> None:
    parser = argparse.ArgumentParser(description="Plot README Task 5 web-rwkv benchmark CSV.")
    parser.add_argument("--csv", type=Path, default=Path("results/task5_web_rwkv.csv"))
